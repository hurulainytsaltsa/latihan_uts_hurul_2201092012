...
import 'package:latihan_uts/screen_page/page_detail_berita_latihan.dart';
import 'package:latihan_uts/screen_page/page_login_api_latihan.dart';
import 'package:latihan_uts/screen_page/page_profile_user_latihan.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http
          .get(Uri.parse('http://192.168.43.45/edukasi_server_latihan/getBerita.php'));

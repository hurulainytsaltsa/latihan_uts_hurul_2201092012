...
import 'package:latihan_uts/screen_page/page_list_berita_latihan.dart';
import 'package:latihan_uts/screen_page/page_register_api_latihan.dart';
  ...
  Future<ModelLatihanLogin?> loginAccount() async {
    ...
    try {
      ...
      http.Response response = await http.post(
          Uri.parse('http://192.168.43.45/edukasi_server_latihan/login.php'),
          body: {
      ...
      if (data.value == 1) {
        ...
        setState(() {
          ...
          //untuk simpan sesi
          session.saveSession(
              data.value ?? 0, data.id ?? "", data.username ?? "", data.fullname ?? "", data.email ?? "");
